...
public class ItemStatistics extends javax.swing.JDialog {
    ...
    public ItemStatistics(java.awt.Frame parent, boolean modal, String nProductID, InventoryDatabase nid) {
        super(parent, modal);
        initComponents();
